...
public class MainActivity2 extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAvgAcc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<DataRoom> listAcc = dbAcc1.userDao().getAccData();
...
/*switchGPS.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (sensor.getType() == sensor.TYPE_ACCELEROMETER) {
            ...
            DataRoom dataAcc = new DataRoom(sensorEvent.timestamp, sensorEvent.values[0], sensorEvent.values[1], sensorEvent.values[2]);
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        DataWardrive dataGPS = new DataWardrive(location.getLatitude(), location.getLongitude());
